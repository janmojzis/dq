...
alloc.o: alloc.c e.h uint64_pack.h crypto_uint64.h uint64_unpack.h byte.h \
 purge.h alloc.h
...
crypto_core_hsalsa20.o: crypto_core_hsalsa20.c salsa.h crypto_uint32.h \
 uint32_unpack.h cleanup.h crypto_core_hsalsa20.h
...
crypto_stream_salsa20.o: crypto_stream_salsa20.c salsa.h crypto_uint32.h \
...
dns_ip.o: dns_ip.c alloc.h byte.h crypto_uint16.h uint16_unpack_big.h \
...
dns_verbosity.o: dns_verbosity.c stralloc.h writeall.h iptostr.h \
 porttostr.h numtostr.h e.h uint16_unpack_big.h crypto_uint16.h byte.h \
 dns.h
...
log.o: log.c buffer.h uint32_unpack_big.h crypto_uint32.h \
 uint16_unpack_big.h crypto_uint16.h e.h byte.h iptostr.h numtostr.h \
 log.h crypto_uint64.h
...
printpacket.o: printpacket.c uint16_unpack_big.h crypto_uint16.h e.h \
 byte.h dns.h stralloc.h printrecord.h printpacket.h
	$(CC) $(CFLAGS) $(CPPFLAGS) -c printpacket.c

printrecord.o: printrecord.c uint16_unpack_big.h crypto_uint16.h \
 uint32_unpack_big.h crypto_uint32.h e.h byte.h dns.h stralloc.h \
 printrecord.h iptostr.h
...
response.o: response.c dns.h stralloc.h byte.h uint16_pack_big.h \
 crypto_uint16.h uint32_pack_big.h crypto_uint32.h response.h
...
salsa.o: salsa.c crypto_uint64.h crypto_uint32.h uint32_pack.h \
 uint32_unpack.h cleanup.h salsa.h
	$(CC) $(CFLAGS) $(CPPFLAGS) -c salsa.c

seconds.o: seconds.c seconds.h
	$(CC) $(CFLAGS) $(CPPFLAGS) -c seconds.c

siphash.o: siphash.c uint64_pack.h crypto_uint64.h uint64_unpack.h \
 siphash.h
...
typeparse.o: typeparse.c strtonum.h uint16_pack_big.h crypto_uint16.h \
 case.h dns.h stralloc.h byte.h typeparse.h
	$(CC) $(CFLAGS) $(CPPFLAGS) -c typeparse.c

uint16_pack_big.o: uint16_pack_big.c uint16_pack_big.h crypto_uint16.h
...
uint64_pack.o: uint64_pack.c uint64_pack.h crypto_uint64.h
	$(CC) $(CFLAGS) $(CPPFLAGS) -c uint64_pack.c

uint64_unpack.o: uint64_unpack.c uint64_unpack.h crypto_uint64.h
