...
extern void log_query(crypto_uint64 *,const unsigned char [16],unsigned char [2],const unsigned char [2],const unsigned char *,const unsigned char [2]);
...
extern void log_tcpopen(const unsigned char [16],unsigned char [2]);
extern void log_tcpclose(const unsigned char [16],unsigned char [2]);

extern void log_cachedanswer(const unsigned char *,const unsigned char [2]);
...
extern void log_tx(const unsigned char *,const unsigned char [2],const unsigned char *,const unsigned char [256],const unsigned char [528],int,unsigned int);

extern void log_nxdomain(const unsigned char *,const unsigned char *,unsigned int);
extern void log_nodata(const unsigned char *,const unsigned char *,const unsigned char [2],unsigned int);
...
extern void log_rr(const unsigned char *,const unsigned char *,const unsigned char [2],const unsigned char *,unsigned int,unsigned int,unsigned char);
...
extern void log_rrmx(const unsigned char *,const unsigned char *,const unsigned char *,const unsigned char [2],unsigned int,unsigned char);
extern void log_rrsoa(const unsigned char *,const unsigned char *,const unsigned char *,const unsigned char *,const unsigned char [20],unsigned int,unsigned char);
