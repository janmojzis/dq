...
unsigned char key[crypto_core_hsalsa20_KEYBYTES + 16];
unsigned char out[crypto_core_hsalsa20_OUTPUTBYTES + 16];
unsigned char in[crypto_core_hsalsa20_INPUTBYTES + 16];
unsigned char c[crypto_core_hsalsa20_CONSTBYTES + 16];
